...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  %>
  	<table border="3" bordercolor="red" cellspacing="3" bgcolor="pink">
  		<tr bordercolor="green" bgcolor="#3975f3"><th>Name</th>
  			<th>Age</th>
  			<th>Gender</th>
  			<th>Country</th>
  			<th>SeatFor</th>
  	...
  	<%
  	 ...
  	 %>
  	 <tr><td colspan="4" align="center">TotalPrice</td><td colspan="4" align="center"><s:property value="totPrice"/></td></tr>
  	</table>
  	<%
  		}
  	 %>
  	<form action="Buy">
  	<table>
  	<tr><td><s:submit value="Buy"></s:submit></td></tr>
  	</table>
  	</form> 
