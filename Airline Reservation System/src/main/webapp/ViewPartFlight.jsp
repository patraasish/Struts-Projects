...
<HTML>
<HEAD>
<TITLE>ViewPartFlight.jsp</TITLE>
...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <center>
  	<h1><u>ViewPartFlight Page</u></h1>
  	
  	
  	<table border="2" bordercolor="red" bgcolor="yellow" cellspacing="3" width="80%">
  	<tr>
  		<th align="center">FlightId</th>
  		<th align="center">FlightName</th>
  		<th align="center">Flight Type</th>
  		<th align="center">Total Seat</th>
  		<th align="center">Total Vip Seat</th>
  		<th align="center">Total Gen Seat</th>
  		<th align="center">Total Lux  Seat</th>
  		<th align="center">Source</th>
  		<th align="center">Destination</th>
  		<th align="center">Date</th>
  		<th align="center">Dep. Time</th>
  		<th align="center">Arr. Time</th>
  		<th align="center">Avail Seat</th>
  		<th align="center">Avail Vip</th>
  		<th align="center">Avail Gen</th>
  		<th align="center">Avail Lux</th>
  		<th align="center">Cost Vip</th>
  		<th align="center">Cost Gen</th>
  		<th align="center">Cost Lux</th>
  	</tr>
  	<tr>
  		<td align="center"><s:property value="flightid"/></td>
  		<td align="center"><s:property value="flightname"/></td>
  		<td align="center"><s:property value="fltype"/></td>
  		<td align="center"><s:property value="tot_seat"/></td>
  		<td align="center"><s:property value="tot_vip"/></td>
  		<td align="center"><s:property value="tot_gen"/></td>
  		<td align="center"><s:property value="tot_lux"/></td>
  		<td align="center"><s:property value="from"/></td>
  		<td align="center"><s:property value="to"/></td>
  		<td align="center"><s:property value="date"/></td>
  		<td align="center"><s:property value="deptime"/></td>
  		<td align="center"><s:property value="arrtime"/></td>
  		<td align="center"><s:property value="avail_seat"/></td>
  		<td align="center"><s:property value="avail_vip"/></td>
  		<td align="center"><s:property value="avail_gen"/></td>
  		<td align="center"><s:property value="avail_lux"/></td>
  		<td align="center"><s:property value="cost_vip"/></td>
  		<td align="center"><s:property value="cost_gen"/></td>
  		<td align="center"><s:property value="cost_lux"/></td>
  	</tr>
  	</table>
  	<s:form action="EditPerFlight">
  	<table width="80%">
  	...
  	<tr><td align="center"><s:submit value="Edit"></s:submit></td></tr>
  	<tr><td align="center"><s:submit value="Delete" action="DelPerFlightInfo"></s:submit></td></tr>
  	</table>
  	</s:form>
  	</center>
