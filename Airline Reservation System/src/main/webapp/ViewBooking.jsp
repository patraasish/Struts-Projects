...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <center>
  	<h1><u>ViewBooking Page</u></h1>
  	
  	<table>
  	<s:form name="Adfl" action="ViewBooking1">
  	...
  	<tr><td><s:textfield name="date" label="Date (dd-mm-yy) "></s:textfield></td></tr>
  	<tr><td><s:submit value="View"></s:submit></td><td><s:reset value="Reset"></s:reset></td></tr>
  	</s:form>
  	</table>
  	</center>
