...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <center>
  	<h1><u>BankChoose Page</u></h1>
  	<br/><br/><br/>
  	<form action="ChooseBank">
  	<table>
  	<tr><td><s:hidden name="banking"></s:hidden></td></tr>
  	<tr><td><s:radio name="bank" list="{'SBI'}"></s:radio></td></tr>
  	<tr><td><s:radio name="bank" list="{'ICICI'}"></s:radio></td></tr>
