...
<HTML>
<HEAD>
<TITLE>ViewCancellation.jsp</TITLE>
...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <center>
  	<h1><u>ViewCancellation Page</u></h1>
  	<br/>
  	...
  	<tr>
  		<td align="center"><s:property value="pnrno"/></td>
  		...
  		<td align="center"><s:property value="bookdate"/></td>
  		<td align="center"><s:property value="seat"/></td>
  		<td align="center"><s:property value="amount"/></td>
  		<td align="center"><s:property value="bank"/></td>
  		<td align="center"><s:property value="accountno"/></td>
  		...
  		<td align="center"><s:property value="stclas"/></td>
  	</tr>
  	</table>
  	<br>
  	...
  	<table>
	  	...
	  	<tr><td><s:submit value="Cancel"></s:submit></td></tr>
  	</table>
  	</s:form>
  	<br/><br/><br/>
