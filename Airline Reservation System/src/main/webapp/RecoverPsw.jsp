...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <center>
  	<h1><u>RecoverPsw Page</u></h1>
  	
  	  	  	
  	<table>
  	<s:form action="RecoverPsw">
  	<tr><td><s:hidden name="username"></s:hidden></td></tr>
  	<tr><td><s:textfield name="secqus" label="Security Question " readonly="true"></s:textfield></td></tr>
  	<tr><td><s:textfield name="secans" label="Answer "></s:textfield></td></tr>
