...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <center>
  	<h1><u>ViewCustomer Page</u></h1>
  	<table>
  	<s:form action="SelectCust">
  	<tr><td><s:select name="custid" list="custmap" label="Select Customer" headerKey="-1" headerValue="--Please Select--"></s:select></td></tr>
  	<tr><td><s:submit value="Show"></s:submit></td></tr>
  	</s:form>
