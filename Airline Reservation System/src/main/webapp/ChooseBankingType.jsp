...
<HTML>
<HEAD>
<TITLE>ChooseBankingType.jsp</TITLE>
...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <center>
  	<h1><u>ChooseBankingType Page</u></h1>
  	<br/><br/><br/>
  	<table>
  		<tr>
  			<td>
  				<s:url id="NetBankingURL" action="NetBanking">
  				<s:param name="id" value="'NetBanking'"></s:param>
  				</s:url>
  				<s:a href="%{NetBankingURL}">Net Banking</s:a>
  			</td>
  		</tr>
