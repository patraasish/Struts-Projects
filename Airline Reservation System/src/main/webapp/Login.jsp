...
<BODY bgcolor="yellow" LEFTMARGIN=0 TOPMARGIN=0 MARGINWIDTH=0 MARGINHEIGHT=0>
<!-- ImageReady Slices (travel001.psd) -->
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="cyan">
  <tr>
    ...
    <center>
  	...
  	<tr><td><s:radio name="usertype" list="{'admin','customer'}" label="Type " /></td></tr>
  	<tr><td><s:submit value="Login"></s:submit></td><td><s:reset value="Reset"></s:reset></td></tr>
  	</s:form>
  	<tr><td align="center"><a href="ForgotPsw.jsp">Forgot Password</a></td></tr>
  	</table>
  	<br/>
