...
<HTML>
<HEAD>
<TITLE>SBINetBanking2.jsp</TITLE>
...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <center>
  	<h1><u>Welcome to <%=sess1.get("Bank")%> <%=sess1.get("Banking")%>2 Page</u></h1>
  	<br/><br/><br/>
  	</center>
  	<br/><br/>
  	<center>
  	<form action="PaySBINet">
  	<table>
  	...
  	<tr><td><s:password name="password" label="Enter your Transaction Password "></s:password></td></tr>
  	<tr><td><s:submit value="Pay"></s:submit></td></tr>
  	</table>
  	</form>
