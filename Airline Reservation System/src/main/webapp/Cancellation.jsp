...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <center>
  	<h1><u>Cancellation Page</u></h1>
  	<br/>
  	<s:form action="Cancellation">
  	<table>
  	<tr><td><s:textfield name="pnrno" label="PNR_No "></s:textfield></td></tr>  	
  	<tr><td><s:submit value="Show"></s:submit></td></tr>  	
  	<tr><td><s:reset value="Reset"></s:reset></td></tr>  	
  	</table>
  	</s:form>
  	<br/><br/><br/>
