...
<HTML>
<HEAD>
<TITLE>SBINetBanking1.jsp</TITLE>
...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <center>
  	<h1><u>Welcome to <%=sess1.get("Bank")%> <%=sess1.get("Banking")%>1 Page</u></h1>
  	<br/><br/><br/>
  	</center>
  	<br/><br/>
  	<font color="green" size="5">Hello <s:property value="name"/></font><br/><br/><br><br>
  	<center>
  		<font color="#c8349f" size="4" face="Monotype corsiva">
  		Are you interested to buy <%= sess1.get("Seat") %> <%= sess1.get("Clas") %> seat from <%= sess1.get("Flightname") %> worth Rs - <%= sess1.get("TotPrice") %>.
  		</font>
  	<br/><br/>
  
  	
  	
  	<form action="YesSBINet">
  	<table>
  	<tr><td><s:hidden name="accountno"></s:hidden></td></tr>
  	<tr><td><s:hidden name="amount"></s:hidden></td></tr>
  	<tr><td><s:hidden name="trpassword"></s:hidden></td></tr>
