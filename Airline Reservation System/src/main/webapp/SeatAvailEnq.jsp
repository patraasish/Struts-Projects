...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <center>
  	<h1><u>Seat Availability Enquire Page</u></h1>
  	<br>
  	
  	<table>
  	<s:form action="CheckFlt">
  	...
  	<tr><td><s:textfield name="seat" label="No_Of_Seat "></s:textfield></td></tr>
