...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="orange">
  <tr>
    ...
    <center>
  	...
  	<table>
	<s:form name="reg" action="RegnAction" onsubmit="return ValidateForm(this);">
  	<tr><td><s:textfield name="firstname" label="First Name "></s:textfield></td></tr>
  	<tr><td><s:textfield name="lastname" label="Last Name "></s:textfield></td></tr>
  	<tr><td><s:textfield name="username" label="User Name "></s:textfield></td></tr>
  	<tr><td><div id="uname"></div></td></tr>
  	<tr><td><s:password name="password" label="Password "></s:password></td></tr>
  	<tr><td><s:password name="conpassword" label="Confirm Password "></s:password></td></tr>
  	<tr><td><s:textfield name="age" label="Age " onkeypress="return NumberValdation(event);"></s:textfield></td></tr>
  	...
  	<tr><td><s:textfield name="email" label="E_Mail "></s:textfield></td></tr>
  	<tr><td><s:textfield name="mobile" label="Mob_No. " onkeypress="return NumberValdation(event);"></s:textfield></td></tr>
  	<tr><td><s:textarea name="secqus" label="Security Question "></s:textarea></td></tr>
  	<tr><td><s:textarea name="secans" label="Answer "></s:textarea></td></tr>
  	
  	<tr><td><s:submit value="Submit"></s:submit></td><td><s:reset value="Reset"></s:reset></td></tr>
  	</s:form>
  	
  	<tr><td><font size="4" color="red"><s:property value="msg"/></font></td></tr>
  	</table>
