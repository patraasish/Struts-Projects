...
<HTML>
<HEAD>
<TITLE>BookPartFlight.jsp</TITLE>
  ...
  <tr>
              ...
              <td height="158" valign="bottom" background="images/index_31.jpg">
                ...
                <td>
					<a href="Login.jsp">Login</a><br>
				  	...
				  	<a href="FareEnq">Fare Enquire</a><br>
                </td>
                </tr>
    ...
    <center>
  	...
  	<tr>
  		...
  		<th align="center">Avail <%= s1 %></th>
  		<th align="center">Cost <%= s1 %></th>
  	</tr>
  	<tr>
  		...
  		<td align="center"><s:property value="avail"/></td>
  	...
  	<table width="80%">
  		...
  		<tr><td><s:hidden name="avail_seat"></s:hidden></td></tr>
  		<tr><td><s:hidden name="avail"></s:hidden></td></tr>
  		<tr><td align="center"><s:submit value="Book"></s:submit></td></tr>
  	</table>
  	</s:form>
  	</center>
