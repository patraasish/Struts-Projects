...
<script type="text/javascript">
 ...
 function func(str)
	...
	ob.onreadystatechange=function()
		...
		if(ob.readyState==4)
			{
			document.Adfl.flightid.value=ob.responseText;
			}
		}
	var url="/AirTkt/GetFlightid";
	url=url+"?fid="+str;
	ob.open("GET",url,true);
	ob.send(null);
 	} 		
 </script>
<TITLE>FareEnq.jsp</TITLE>
  ...
  <tr>
    <td align="center" valign="top"><table width="770" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="112" background="images/butbg.jpg"><div align="center"><span class="style31"></span></div></td>
              ...
              <td height="158" valign="bottom" background="images/index_31.jpg">
                ...
                <td>
					<a href="LoginPage">Login</a><br>
				  	<a href="NewUser.jsp">NewUser</a><br/>
				  	<a href="SeatAvailEnq">Seat Availability</a><br>
				  	<a href="FareEnq">Fare Enquire</a>
                </td>
                </tr>
    ...
    <center>
  	<h1><u>Fare Enquire Page</u></h1>
  	<br>
	
  	<table>
  	<s:form name="Adfl" action="CheckFare">
  	<tr><td><s:select name="fid" label="Flight Name " list="fltnm" headerKey="-1" headerValue="----Please Select----" onchange="func(this.value);"></s:select></td></tr>
  	<tr><td><s:textfield name="flightid" label="Flight No "></s:textfield></td></tr>
  	<tr><td><s:select name="from" label="From " list="place" headerKey="-1" headerValue="----Please Select----"></s:select></td></tr>
  	<tr><td><s:select name="to" label="To " list="place" headerKey="-1" headerValue="----Please Select----"></s:select></td></tr>
  	<tr><td><s:textfield name="date" label="Date "/></td></tr>
  	<tr><td><s:select name="stclas" label="Class " list="clas" headerKey="-1" headerValue="----Please Select----"></s:select></td></tr>
  	<tr></tr><tr></tr>
  	<tr><td colspan="2" align="center">No of Seats :</td></tr>
  	<tr></tr>
  	<tr><td><s:textfield name="seat" label="For Adult "></s:textfield></td></tr>
  	<tr><td><s:textfield name="seatno" label="For Child "></s:textfield></td></tr>
  	
  	<tr><td><s:submit value="Show"></s:submit></td><td><s:reset value="Reset"></s:reset></td></tr>
  	</s:form>
  	</table>
  	</center>
