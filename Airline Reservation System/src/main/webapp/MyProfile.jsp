...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <center>
  	<h1><u>MyProfile Page</u></h1>
  	<br/><br/><br/>
  	
  	<table border="3" bordercolor="red" cellspacing="4" cellpadding="10" bgcolor="pink">
  		<tr>
  			<th>Loginid</th>
  			<th>Username</th>
  			<th>Firstname</th>
  	...
  	<br/>
  	<center>
  	<s:form action="EditOwn">
  	<table width="80%">
  	<tr><td><s:hidden name="custid"></s:hidden></td></tr>
  	<tr><td align="right"><s:submit value="Edit"></s:submit></td></tr>
  	</table>
  	</s:form>
  	</center>
