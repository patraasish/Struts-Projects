  ...
  <tr>
    <td align="center" valign="top"><table width="770" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="112" background="images/butbg.jpg"><div align="center"><span class="style31"><a href="Logout">Logout</a></span></div></td>
          ...
          <td width="250" align="center"><table width="226" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="158" valign="bottom" background="images/index_31.jpg">
                ...
                <tr>
                <td>
					<a href="FlightManagement">Flight Management</a><br>
				  	<a href="CustomerManagement">CustomerManagement</a><br>
				  	<a href="ViewBooking">View Booking</a><br>
	...
	<table border="2" bordercolor="red" bgcolor="yellow" cellspacing="3" width="80%">
  	<tr>
  		...
  		<th align="center">Available Seat</th>
...
<%
  	...
  	Vector<LoginAction> v=(Vector<LoginAction>)sess1.get("Vec");
  	LoginAction l=new LoginAction();
  	  	
%>
  <br/>
  <h1 align="left"><u>Current Booking Status</u></h1>
  	<table border="2" bordercolor="red" bgcolor="yellow" cellspacing="3" width="80%">
  	<tr>
  		...
  		<th align="center">Flightid</th>
  		<th align="center">Flight Name</th>
  		<th align="center">Date Of Journey</th>
...
<%
  	for(int i=0; i < v.size();i++)
  		{
  		LoginAction la= (LoginAction) v.elementAt(i);
%>
  	<tr>
  		<td align="center"><%=la.getPnrno()%></td>
  		<td align="center"><%=la.getCustid() %></td>
  		<td align="center"><%=la.getFlightid()%></td>
  		<td align="center"><%=la.getFlightname() %></td>
  		<td align="center"><%=la.getDate() %></td>
  		<td align="center"><%=la.getBookdate() %></td>
  		<td align="center"><%=la.getSeat() %></td>
  		<td align="center"><%=la.getAmount()%></td>
  		<td align="center"><%=la.getBank() %></td>
  		<td align="center"><%=la.getAccountno()%></td>
  		<td align="center"><%=la.getFrom() %></td>
  		<td align="center"><%=la.getTo() %></td>
  		<td align="center"><%=la.getDeptime() %></td>
  		<td align="center"><%=la.getStclas() %></td>
