  ...
  Map sess1=ActionContext.getContext().getSession();
   %>
  	...
  	<tr>
  		...
  		<td align="center"><%=sess1.get("Clas") %></td>
  		<td align="center"><%=sess1.get("Cost") %></td>
  		<td align="center"><%=sess1.get("Seat") %></td>
  	</tr>
  	</table>
  	<s:form action="BookTkt">
  	<table width="80%">
  		<tr><td><s:hidden name="flightid"></s:hidden></td></tr>
  		<tr><td><s:hidden name="flightname"></s:hidden></td></tr>
  		<tr><td><s:hidden name="from"></s:hidden></td></tr>
  		<tr><td><s:hidden name="to"></s:hidden></td></tr>
