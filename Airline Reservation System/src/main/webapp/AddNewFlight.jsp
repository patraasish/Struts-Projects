...
<script type="text/javascript">
 ...
 function func(str)
	...
	ob.onreadystatechange=function()
		...
		if(ob.readyState==4)
			{
			document.getElementById("chkflt").innerHTML=ob.responseText;
			}
		}
	var url="/AirTkt/CheckFlightid";
	url=url+"?fid="+str;
	ob.open("GET",url,true);
	ob.send(null);
 	} 		
 </script>
<TITLE>AddNewFlight.jsp</TITLE>
...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <center>
  	<h1><u>AddNewFlight Page</u></h1>
  	
  	<table>
  	<s:form name="Adflt" action="AddFl" onsubmit="return AddNewFl(this);">
  	<tr><td><s:textfield name="flightid" label="Flight No " onblur="func(this.value);"></s:textfield></td></tr>
  	<tr><td><div id="chkflt"></div></td></tr>
  	<tr><td><s:textfield name="flightname" label="Flight Name "></s:textfield></td></tr>
  	<tr><td><s:radio name="fltype" label="Flight Type " list="{'Domestic','International'}"></s:radio></td></tr>
  	<tr><td><s:textfield name="rundays" label="Running_Days " onkeypress="return NumberValdation(event);"></s:textfield></td></tr>
  	<tr><td><s:textfield name="tot_seat" label="Total Seat " onkeypress="return NumberValdation(event);"></s:textfield></td></tr>
  	<tr><td><s:textfield name="tot_vip" label="Total_Seat Vip " onkeypress="return NumberValdation(event);"></s:textfield></td></tr>
  	<tr><td><s:textfield name="tot_gen" label="Total_Seat Gen " onkeypress="return NumberValdation(event);"></s:textfield></td></tr>
  	<tr><td><s:textfield name="tot_lux" label="Total_Seat Lux " onkeypress="return NumberValdation(event);"></s:textfield></td></tr>
  	<tr><td colspan="2" align="right"><s:submit value="Add" theme="simple"></s:submit><s:reset value="Reset" theme="simple"></s:reset></td></tr>
  	</s:form>
  	</table>
  	</center>
