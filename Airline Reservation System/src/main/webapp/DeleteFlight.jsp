...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <center>
  	<h1><u>DeleteFlight Page</u></h1>
  	<table>
  	<s:form action="ShDelFlight">
  	<tr><td><s:select name="fid" label="Flight Name " list="fltnm" headerKey="-1" headerValue="----Please Select----"></s:select></td></tr>
  	<tr><td><s:submit value="Delete"></s:submit></td><td><s:reset value="Reset"></s:reset></td></tr>
  	</s:form>
  	</table>
  	</center>
