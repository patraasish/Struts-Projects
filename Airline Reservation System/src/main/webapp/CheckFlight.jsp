...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <center>
  	<h1><u>CheckFlight Page</u></h1>
  	<br>
  	<s:hidden name="seat"></s:hidden>
  <%
  ...
  %>
  	<tr>
  		...
  		<td><a href="ShowFl?&flightid=<%=la.getFlightid()%>&flightname=<%=la.getFlightname()%>&from=<%=la.getFrom()%>&to=<%=la.getTo()%>&date=<%=la.getDate()%>&deptime=<%=la.getDeptime()%>&avail_seat=<%=la.getAvail_seat()%>">Show</a>
  		</td>
  	</tr>
  <%
  		}
