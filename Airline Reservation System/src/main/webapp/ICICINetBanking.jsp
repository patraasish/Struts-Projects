...
<HTML>
<HEAD>
<TITLE>ICICINetBanking.jsp</TITLE>
...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <center>
  	<h1><u>Welcome to ICICI NetBanking Page</u></h1>
  	<br/><br/><br/>
  	<form action="LoginBank">
  	<table>
  	<tr><td><s:textfield name="accountno" label="Account_No "></s:textfield></td></tr>
