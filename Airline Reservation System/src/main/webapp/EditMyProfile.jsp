...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <center>
  	<h1><u>EditMyProfile Page</u></h1>
  	<br/><br/><br/>
  	
  	<form action="UpdateOwn">
  	<table>
	  	<tr><td><s:hidden name="custid"></s:hidden></td></tr>
	  	<tr><td><s:textfield name="username" label="User Name " readonly="true"></s:textfield></td></tr>
	  	...
	  	<tr><td><s:textfield name="mobile" label="Mobile "></s:textfield></td></tr>
