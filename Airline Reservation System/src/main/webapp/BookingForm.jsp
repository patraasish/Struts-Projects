...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <center>
  	<h1><u>BookingForm Page</u></h1>
  	<br/><br/><br/>
  <%
  Map sess1=ActionContext.getContext().getSession();
  Vector<LoginAction> v=(Vector<LoginAction>)sess1.get("Pass");
  if(v != null)
  	{
  %>
  	<table border="3" bordercolor="red" cellspacing="3" bgcolor="pink">
  		<tr bordercolor="green" bgcolor="#3975f3">
  			<th>Name</th>
  			<th>Age</th>
  			<th>Gender</th>
  			<th>Country</th>
  	...
  	%>
  	<tr bordercolor="yellow" bgcolor="#7f8c98">
  		<td align="center"><%=la.getName()%></td>
  		<td align="center"><%=la.getAge() %></td>
  		<td align="center"><%=la.getGender() %></td>
  		<td align="center"><%=la.getCountry() %></td>
  		<td align="center"><%=la.getSeatfor() %></td>
  		<td align="center"><%=la.getConcession()%></td>
  		<td align="center"><%=la.getIdentityno() %></td>
  		<td align="center"><%=la.getPrice() %></td>
  	</tr>
  	<%
  		}
  	 %>
  	...
  	<br/><br/><br/>
  	<form name="frm" action="AddPassenger">
  	<table>
  	
  		<tr><td><s:hidden name="no"></s:hidden></td></tr>
  		<tr><td><s:textfield name="name" label="Name "></s:textfield></td></tr>
  		<tr><td><s:textfield name="age" label="Age "></s:textfield></td></tr>
  		<tr><td><s:radio name="gender" label="Gender " list="{'Male','Female'}"></s:radio></td></tr>
  		<tr><td><s:textfield name="country" label="Country "></s:textfield></td></tr>
  		<tr><td><s:radio name="seatfor" label="Seat For " list="{'Adult','Child'}"></s:radio></td></tr>
  		<tr><td><s:select name="concession" label="Concession Type " list="{'Non','Handicap','Senior Citigen'}"></s:select></td></tr>
  		<tr><td><s:textfield name="identityno" label="Identity No "></s:textfield></td></tr>
  		<tr><td><s:textfield name="price" label="Price "></s:textfield></td></tr>
  		<tr><td><s:submit value="Add"></s:submit></td></tr>
   		
   		
   		<tr><td><s:submit value="Submit" action="SubmitPassanger"></s:submit></td></tr>
   		<tr><td align="center"><s:submit value="Book" action="Buy"></s:submit></td></tr>
   		<tr><td><a href="BookPartFlight"> BookPartFlight</a></td></tr>
   		<tr><td><a href="BookPartFlt.jsp">BookPartFlt</a></td></tr>
   		  		<tr><td><a href="ChooseBankingType.jsp">choose bank type</a></td></tr>
