...
<HTML>
<HEAD>
<TITLE>PasswordChange.jsp</TITLE>
...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <center>
  	<h1><u>PasswordChange Page</u></h1>
  	<br/>
  	<br/><br/><br/>
  	<FONT size="4" color="green">Hello <s:property value="username"/>...........</FONT><br/><br/><br/>
  	<s:form action="ChangePass">
  	<s:hidden name="custid"></s:hidden>
  	<table>
  		<tr><td><s:textfield name="password" label="OldPassword "></s:textfield></td></tr>
  		<tr><td><s:textfield name="newpassword" label="NewPassword "></s:textfield></td></tr>
  		<tr><td><s:textfield name="conpassword" label="ConPassword "></s:textfield></td></tr>
  		<tr><td><s:submit value="Change"></s:submit></td></tr>
  	</table>
  	</s:form>
  	</center>
